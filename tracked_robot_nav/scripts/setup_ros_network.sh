...
echo "   scp -r /home/x4/ros2_ws/src/tracked_robot_nav/config/*.rviz user@192.168.1.74:~/rviz_configs/"
echo ""
echo "3. Copy the example map files to your remote machine (optional, for reference):"
echo "   scp -r /home/x4/ros2_ws/src/example_project/agv_proto/maps/* user@192.168.1.74:~/maps/"
echo ""
echo "4. Copy the run_rviz_remote.sh script to your remote machine:"
echo "   scp /home/x4/ros2_ws/src/tracked_robot_nav/scripts/run_rviz_remote.sh user@192.168.1.74:~/"
echo ""
