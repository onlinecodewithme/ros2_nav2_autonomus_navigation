...
def generate_launch_description():
    ...
    speedlimit_params_file = os.path.join(nav_dir, 'config', 'speedlimit_nav2_params.yaml')
    map_file = os.path.join(nav_dir, 'maps', 'map_speedlimit.yaml')
    ...
    return LaunchDescription([
        ...
        # Costmap filter info server for speed limits
        Node(
            ...
            parameters=[{'use_sim_time': use_sim_time},
                        ...
                        {'type': 1},  # 1 for speed limits
                        {'filter_info_frame': 'map'},
                        {'base_frame': 'base_link'},
                        {'transform_tolerance': 0.1}]
        ),
        
        # Filter mask server for speed limits
        Node(
            package='nav2_map_server',
        ...
        Node(
            ...
            name='amcl',
            output='screen',
            parameters=[speedlimit_params_file]
        ),
