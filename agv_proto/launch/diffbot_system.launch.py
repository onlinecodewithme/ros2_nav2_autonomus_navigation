...
def generate_launch_description():
    ...
    # Comment out the spawner nodes for now to get the launch file working
    # spawn_dd_controller = Node(
    #     package="controller_manager",
    #     executable="python3",
    #     arguments=["-m", "controller_manager.spawner", "diffbot_base_controller"],
    #     output="screen",
    # )
    # spawn_jsb_controller = Node(
    #     package="controller_manager",
    #     executable="python3",
    #     arguments=["-m", "controller_manager.spawner", "joint_state_broadcaster"],
    #     output="screen",
    # )
