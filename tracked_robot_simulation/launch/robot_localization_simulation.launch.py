...
def generate_launch_description():
    ...
    # Log info for debugging
    log_ekf = LogInfo(msg="Starting robot_localization EKF node...")
    
    # Robot localization EKF node for handling transforms
    ekf_node = Node(
    ...
    # Log info for debugging
    log_odom_tf = LogInfo(msg="Starting C++ Odometry to TF node...")
    
    # C++ Odometry to TF node
    odom_to_tf_node = Node(
        ...
        parameters=[{
            'use_sim_time': use_sim_time,
            'odom_topic': '/odom',
            'parent_frame': 'odom',  # Using odom as parent frame
    ...
    return LaunchDescription([
        ...
        log_odom_tf,
        odom_to_tf_node,  # Using our odom_to_tf node instead of static transform
        
        log_ekf,
        ekf_node,  # Robot localization EKF node
